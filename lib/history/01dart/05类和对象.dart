...
class Person {
  ...
  Person.withInitializer2(this.firstName, this.lastName)
...
class Person1 {
  ...
  factory Person1(String name, int age) {
    if (_cache.containsKey(name)) {
      return _cache[name]!;
    } else {
      final p = Person1._internal(name, age);
      _cache[name] = p;
      return p;
    }
  }

  Person1._internal(this.name, this.age);
}
